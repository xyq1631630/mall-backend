...
import com.mall.backend.common.api.CommonResult;
...
public class GlobalExceptionHandler {
    ...
    public CommonResult handleSQLSyntaxErrorException(SQLSyntaxErrorException e) {
        ...
        if (StrUtil.isNotEmpty(message) && message.contains("denied")) {
            message = "You don't have permission to modify during the demo. If you want to modify the data please set up local backend service.";
        }
